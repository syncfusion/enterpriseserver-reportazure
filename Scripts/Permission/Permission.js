        ...
        $.ajax({
            ...
            success: function (result, data) {
                ...
                if (scope.length > 0) {
                    ...
                    $("#scope-selection").html(options).attr("disabled", false).selectpicker("refresh");
                }
                else {
                    $("#scope-selection").html(options).attr("disabled", true).selectpicker("refresh");
                }
