...
$(document).on("click", ".web-designer", function (e) {
    ...
    $.ajax({
        url: baseUrlForValidateReport + '/ReportService/api/Designer/IsReportCompatible',
        async: true,
        crossDomain: true,
        dataType: 'json',
        type: 'POST',
        data: JSON.stringify({
            reportPath: "/" + $(this).attr("data-category-name") + "/" + $(this).attr("data-name"),
            serverUrl: baseUrlForValidateReport
        }),
