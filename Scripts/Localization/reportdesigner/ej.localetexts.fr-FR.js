ej.ReportDesigner.Locale['fr-FR'] = {
    itemPanel: {
        ...
        groupItems: {
            ...
            dataRegions: {
                ...
                Items: {
                    'grid': {
                        displayText: 'la grille',
                        tooltip: {
                            requirements: '1 ou plusieurs colonnes.',
                            description: 'Affiche les données tabulaires avec des options pour trier les éléments.',
                            title: 'la grille'
                        }
                    },
                    'pivotgrid': {
                        displayText: 'Tableau croisé dynamique',
                        tooltip: {
                            requirements: '1 ou plusieurs lignes / colonnes.',
                            description: 'Affiche des données résumées dans un format tabulaire croisé.',
    ...
    codeDialog: {
        ...
        reference: {
            ...
            headerText: 'Liste de références'
        },
        classes: {
            title: 'Classes',
