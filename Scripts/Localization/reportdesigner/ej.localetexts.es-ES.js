ej.ReportDesigner.Locale['es-ES'] = {
    itemPanel: {
        ...
        groupItems: {
            ...
            dataRegions: {
                ...
                Items: {
                    'grid': {
                        displayText: 'Cuadrícula',
                        tooltip: {
                            requirements: '1 o más columnas.',
                            description: 'Muestra datos tabulares con opciones para ordenar elementos',
                            title: 'Cuadrícula'
                        }
                    },
                    'pivotgrid': {
    ...
    codeDialog: {
        ...
        reference: {
            ...
            headerText: 'Lista de referencias'
        },
        classes: {
            title: 'Las clases',
