            ...
            dataRegions: {
                ...
                Items: {
                    'grid': {
                        displayText: 'Grid',
                        tooltip: {
                            requirements: '1 or more columns.',
                            description: 'Displays tabular data with options to sort items.',
                            title: 'Grid'
                        }
                    },
                    'pivotgrid': {
                        ...
                        tooltip: {
                            ...
                            description: 'Displays summarized data in a cross tabular format.',
                            title: 'PivotGrid'
                        }
                    },
                    'tablix': {
