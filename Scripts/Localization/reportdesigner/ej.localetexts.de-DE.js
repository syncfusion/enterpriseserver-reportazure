ej.ReportDesigner.Locale['de-DE'] = {
            ...
            distribution: {
                ...
                Items: {
                    ...
                    'smoothLineWithMarkers': {
                        displayText: 'SmoothLine mit Markern',
                        tooltip: {
                            requirements: '1 oder mehr Werte und 1 oder mehr Spalten.',
            ...
            dataRegions: {
                ...
                Items: {
                    'grid': {
                        displayText: 'Gitter',
                        tooltip: {
                            requirements: '1 oder mehr Spalten.',
                            description: 'Zeigt Tabellendaten mit Optionen zum Sortieren von Elementen an.',
                            title: 'Gitter'
                        }
                    },
                    'pivotgrid': {
                        displayText: 'PivotGrid',
                        tooltip: {
                            requirements: '1 oder mehr Zeilen / Spalten.',
                            description: 'Zeigt zusammengefasste Daten in einem tabellenübergreifenden Format an.',
                            title: 'PivotGrid'
                        }
                    },
                    'tablix': {
    ...
    dataField: {
        ...
        dsNameValidation: {
            nameWarning: 'Geben Sie den DataSet-Namen an',
            nameAlert: 'Der angegebene Name ist bereits in der DataSet-Liste vorhanden',
            nameValidation: 'Der DataSet-Name darf keine Leerzeichen und Sonderzeichen enthalten'
        }
    },
    dataPanel: {
        itemTooltip: {
    ...
    rowColumnGroup: {
        ...
        contextSubMenu: {
            ...
            totalafter: 'Nach',
            totalbefore: 'Vor',
            childGroupAlert: 'Gruppe kann nicht in Details eingefügt werden.'
        }
    },
    tablixContextMenu: {
        rowMenu: {
