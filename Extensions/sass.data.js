var SASSDataSource = (function () {
    ...
    SASSDataSource.prototype.renderSassPanel = function () {
        ...
        this.renderTextBoxItem(this.getLocale('promptLabel'), this.id + '_sass_prompt', false, sassConfigTable, 218);
        this.renderTextBoxItem(this.getLocale('userName'), this.id + '_sass_usr', false, sassConfigTable, 218);
        this.renderTextBoxItem(this.getLocale('password'), this.id + '_sass_pswd', true, sassConfigTable, 218);
    ...
    SASSDataSource.prototype.renderErrIndictor = function (target, ctrlId) {
    ...
    SASSDataSource.prototype.renderErrorToolTip = function (id) {
    ...
    SASSDataSource.prototype.showErrTip = function (ctrlId, args) {
        args.preventDefault();
    ...
    SASSDataSource.prototype.hideErrTip = function (ctrlId, args) {
